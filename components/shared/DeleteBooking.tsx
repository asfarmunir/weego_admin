...
import { deleteUserBooking } from "@/lib/database/actions/booking.action";
...
const Delete = ({ id }: { id: string }) => {
  ...
  const deleteAcc = async () => {
    ...
    const res = await deleteUserBooking(id);
    toast.dismiss();
    if (res.status !== 200) {
      ...
      <AlertDialogContent className="p-0 pb-10 transition-all dark:bg-[#161313CC] border-none 2xl:min-w-[600px]">
        ...
        <div className="p-6 flex flex-col items-center">
          ...
          <p className=" text-center">
            Are you sure to delete this booking, it will be deleted permenently
