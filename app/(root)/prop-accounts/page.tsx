...
import CreatePropAccount from "@/components/shared/modals/CreatePropAccount";

const page = () => {
  return (
    <div className=" w-full px-7 mt-7 2xl-mt-8">
      <p className=" font-thin text-xs 2xl:text-sm">Sales Management</p>
      <h1 className=" text-4xl 2xl:text-5xl font-bold">User Accounts</h1>
      <div
            ...
            <TableBody>
              {Array.from({ length: 6 }).map((_, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell className=" text-xs  text-primary 2xl:text-sm font-semibold">
                    10K standart Evaluation - Phase 1 - MTR
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
