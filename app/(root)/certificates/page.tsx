...
import CreateCertification from "@/components/shared/modals/CreateCertification";

const page = () => {
  return (
    <div className=" w-full px-7 mt-7 2xl-mt-8">
      <p className=" font-thin text-xs 2xl:text-sm">Sales Management</p>
      <h1 className=" text-4xl 2xl:text-5xl font-bold capitalize">
        certificates
      </h1>
      <div
            ...
            <TableBody>
              {Array.from({ length: 6 }).map((_, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell className=" ">
                    <p className=" bg-[#80ED99] dark:bg-[#80ed9935] text-primary flex items-center justify-start w-fit px-3 py-2 rounded-full text-xs 2xl:text-sm font-semibold">
                      Payout
                    </p>
                  </TableCell>
                  <TableCell className=" text-xs  text-primary 2xl:text-sm font-semibold">
                    N/09/07/2024 UTC - 09:10:12 PM
                  </TableCell>
