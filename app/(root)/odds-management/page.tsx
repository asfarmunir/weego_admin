...
const page = () => {
  const [tab, setTab] = React.useState<string>("live-odds");
  ...
  return (
    <div className=" w-full px-7 mt-7 2xl-mt-8 overflow-hidden ">
      ...
      <h1 className=" text-4xl 2xl:text-5xl font-bold">Odds Management</h1>
      ...
      </div>
      {
        {
          "live-odds": <LiveOdds />,
          "market-management": <MarketManagement />,
        }[tab]
      }
    </div>
  );
    ...
    >
      <div className=" w-full p-2.5 2xl:p-3.5 flex  flex-col-reverse md:flex-row gap-6 items-center justify-between">
        <div className="flex flex-col md:flex-row w-full md:w-fit  items-center gap-1.5">
          <h3 className="font-semibold pl-4"> Live Odds</h3>
        </div>
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <TableRow key={i} className=" border-none">
                ...
                <TableCell className=" text-xs   rounded-tr-full rounded-br-full text-primary  bg-[#FBFBFB] dark:bg-slate-950 2xl:text-sm font-semibold">
                  <p className=" capitalize w-fit px-4 py-2 rounded-full bg-[#80ED99]/20 dark:border-slate-700 border-slate-200 border">
                    Open
                  </p>
                </TableCell>
              </TableRow>
...
dark:bg-slate-900 mt-6 2xl:mt-8"
    >
      <div className=" w-full p-2.5 2xl:p-3.5 flex  flex-col-reverse md:flex-row gap-6 items-center justify-between">
        <div className="flex flex-col md:flex-row w-full md:w-fit  items-center gap-1.5">
          <h3 className="font-semibold pl-4"> Market Management</h3>
        </div>
        <div className="flex items-center flex-wrap gap-1.5">
          <div className=" bg-white dark:bg-slate-950 inline-flex  w-full md:w-fit items-center px-2 rounded-full">
            <LuSearch className="w-4 h-4 text-[#848BAC] " />
          ...
          <TableBody>
            {Array.from({ length: 6 }).map((_, i) => (
              <TableRow key={i} className=" border-none">
                ...
                <TableCell className=" text-xs   rounded-tr-full rounded-br-full text-primary  bg-[#FBFBFB] dark:bg-slate-950 2xl:text-sm font-semibold">
                  <p className=" capitalize w-fit px-4 py-2 rounded-full bg-sky-600/20 dark:border-slate-700 border-slate-200 border">
                    Surplus
                  </p>
                </TableCell>
              </TableRow>
